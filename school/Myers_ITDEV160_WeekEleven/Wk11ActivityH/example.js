...
//remove third item from list (pine nuts)
var childEl = document.getElementsByTagName('li')[2];				//store third li
var parentEl = childEl.parentNode;									//store li's parent
parentEl.removeChild(childEl);										//remove li with method
